        ...
        <div class="location-match text-xs-center">
            <div class="container"> <span>Your location: <span class="primary-color"><?php
        ...
        <section class="featured-restaurants">
            <div class="container">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="restaurants-filter pull-right">
                            <nav class="primary pull-left">
                                <ul>
                                    <!-- <li><a href="#" class="selected" data-filter="veg">Veg</a> </li>
                                    <li><a href="#" data-filter="nonveg">Non-Veg</a> </li>
                ...
                <div class="row">
                    ...
                    <?php 
                    // print_r($veg_restaurant);die;
                    foreach ($restaurant as $value) {

                        if($value->restaurant_foodtype=='Vegetarian')
                        {
                            $class="veg";
                        }
                        else if($value->restaurant_foodtype=='Non Vegetarian')
                        {
                            $class="nonveg";
                        }
                        else if($value->restaurant_foodtype=='Both (Vegetarian / Non Vegetarian)')
                        {
                            $class="both";
                        }
                    ...
                    <div class="restaurant-listing">
                        <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant <?php echo $class;?>">
                            <div class="restaurant-wrap">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                        <a class="restaurant-logo" href="#"> <img src="http://admin.menukart.online/uploads/restaurant/<?php echo $value->restaurant_logo;?>" alt="Restaurant logo"> </a>
                                    </div>
                                    <!--end:col -->
                                    <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                        <h5><a href="<?php echo base_url();?>menu/<?php echo base64_encode($value->restaurant_id);?>"><?php echo $value->restaurant_name;?></a></h5> <span><?php echo $value->types_of_food;?></span>
                                        <div class="bottom-part">
                                            <div class="cost"><i class="fa fa-check"></i> Min Rs <?php echo $value->restaurant_food_min_price;?></div>
                                            <div class="mins"><i class="fa fa-motorcycle"></i> <?php echo $value->restauran_delivery_min_time;?> min</div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-5 join-text">
                                <p>Join the thousands of other restaurants who benefit from having their menus on <a href="#"><strong> MenuKart directory</strong></a> </p>
                            </div>
